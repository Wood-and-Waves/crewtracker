...
import { buildFinalReportEmail } from '@/lib/finalReportEmail'
...
export async function POST(request: Request) {
  ...
  // The words live in lib/finalReportEmail.ts, like every other message this
  // app sends; this route owns the attachments, the recipients and the lock.
  const mail = buildFinalReportEmail({
    showName: show.name,
    clientCompany: show.client_company ?? null,
    jobNumber: show.job_number ?? null,
