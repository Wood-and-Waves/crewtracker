  ...
  function PunchCell({ type }: { type: PunchType }) {
    ...
    return (
      <button
        ...
        disabled={disabled}
        className={cn(
          'rounded-field px-2 py-2 text-xs font-medium transition-colors text-center tabular-nums',
          done && 'text-ink hover:bg-surface-2',
          !done && !disabled && 'text-accent font-semibold bg-accent-wash ring-1 ring-inset ring-accent hover:opacity-80',
